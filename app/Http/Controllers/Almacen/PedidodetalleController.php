...
use App\Models\Almacen\Pedidodetalle;
use Illuminate\Http\RedirectResponse;
use Illuminate\Http\Request;
use App\Http\Requests\Almacen\PedidodetalleRequest;
...
class PedidodetalleController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('almacen.pedidodetalle.index', compact('pedidodetalles'))
    ...
    public function create(): View
    {
        ...
        return view('almacen.pedidodetalle.create', compact('pedidodetalle'));
    }
    ...
    public function store(PedidodetalleRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('almacen.pedidodetalles.index')
    ...
    public function show($id): View
    {
        ...
        return view('almacen.pedidodetalle.show', compact('pedidodetalle'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('almacen.pedidodetalle.edit', compact('pedidodetalle'));
    }
