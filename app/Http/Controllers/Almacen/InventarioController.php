...
use App\Http\Requests\Almacen\InventarioRequest;
...
class InventarioController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('almacen.inventario.index', compact('inventarios'))
    ...
    public function create(): View
    {
        ...
        return view('almacen.inventario.create', compact('inventario'));
    }
    ...
    public function store(InventarioRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('almacen.inventarios.index')
    ...
    public function show($id): View
    {
        ...
        return view('almacen.inventario.show', compact('inventario'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('almacen.inventario.edit', compact('inventario'));
    }
