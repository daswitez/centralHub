...
select * from planta.v_trazabilidad_lote_salida where codigo_lote_salida = 'LS-2001';
select * from certificacion.v_certificados_por_lote_salida where codigo_lote_salida = 'LS-2001';
select * from almacen.v_stock;
select * from logistica.envio where codigo_envio in ('ENV-9001','ENV-9002','ENV-9003');
select * from almacen.movimiento order by fecha_mov desc limit 10;
