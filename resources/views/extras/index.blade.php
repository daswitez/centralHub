            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="tipoBusqueda" class="form-control select2" style="width: 100%;"
                            onchange="actualizarDropdown()">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select id="dropdown_planta" class="form-control select2 dropdown-lote"
                        ...
                        <select id="dropdown_salida" class="form-control select2 dropdown-lote"
                            style="width: 100%; display: none;">
                        ...
                        <select id="dropdown_orden_envio" class="form-control select2 dropdown-lote"
                            style="width: 100%; display: none;">
                        ...
                        <select id="dropdown_envio" class="form-control select2 dropdown-lote"
                            style="width: 100%; display: none;">
                        ...
                        <select id="dropdown_pedido" class="form-control select2 dropdown-lote"
                            style="width: 100%; display: none;">
