...
@section('page_title', 'Nueva variedad')
        ...
        <div class="col-12 col-md-6">
            ...
            <div class="card card-outline card-dark">
                <div class="card-header">
                    <h3 class="card-title">Crear variedad de papa</h3>
                </div>
                <form method="post" action="{{ route('cat.variedades.store') }}">
                    @csrf
                    <div class="card-body">
