    ...
    <div class="row">
        <div class="col-12 col-md-6">
            ...
            <div class="card card-outline card-dark">
                ...
                <form method="post" action="{{ route('cat.clientes.store') }}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="codigo_cliente">Código</label>
                            <input id="codigo_cliente" name="codigo_cliente" class="form-control" maxlength="40" required value="{{ old('codigo_cliente') }}">
                        </div>
                        <div class="form-group">
                            <label for="nombre">Nombre</label>
                            <input id="nombre" name="nombre" class="form-control" maxlength="160" required value="{{ old('nombre') }}">
                        </div>
                        <div class="form-group">
                            <label for="tipo">Tipo</label>
                            <input id="tipo" name="tipo" class="form-control" maxlength="60" required value="{{ old('tipo') }}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a href="{{ route('cat.clientes.index') }}" class="btn btn-outline-secondary">Cancelar</a>
