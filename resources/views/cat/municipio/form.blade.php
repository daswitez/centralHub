<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="municipio_id" class="form-control @error('municipio_id') is-invalid @enderror" value="{{ old('municipio_id', $municipio?->municipio_id) }}" id="municipio_id" placeholder="Municipio Id">
