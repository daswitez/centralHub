<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="departamento_id" class="form-control @error('departamento_id') is-invalid @enderror" value="{{ old('departamento_id', $departamento?->departamento_id) }}" id="departamento_id" placeholder="Departamento Id">
